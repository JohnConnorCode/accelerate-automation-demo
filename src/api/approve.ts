...
export class ApprovalService {
  ...
  private getTargetTable(type: string): string {
    const tables: Record<string, string> = {
      'project': 'accelerate_startups',
      'projects': 'accelerate_startups',
      'startup': 'accelerate_startups',
    ...
    return tables[type?.toLowerCase()] || 'accelerate_startups';
  }
