...
-- Skip error_logs indexes as table already exists with different columns
...
-- Skip default settings insert as table already exists with different schema
...
-- Skip fetch_history indexes as table already exists
...
-- Skip triggers for existing tables
