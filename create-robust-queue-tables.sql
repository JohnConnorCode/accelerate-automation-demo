...
CREATE INDEX idx_queue_projects_team_size ON queue_projects(team_size);
CREATE INDEX idx_queue_projects_funding ON queue_projects(funding_raised);
CREATE INDEX idx_queue_projects_launch ON queue_projects(launch_date DESC);
CREATE INDEX idx_queue_projects_needs ON queue_projects USING GIN(project_needs);
...
CREATE INDEX idx_queue_funding_deadline ON queue_funding_programs(application_deadline);
CREATE INDEX idx_queue_funding_amount ON queue_funding_programs(min_amount, max_amount);
CREATE INDEX idx_queue_funding_type ON queue_funding_programs(funding_type);
CREATE INDEX idx_queue_funding_sectors ON queue_funding_programs USING GIN(sector_focus);
...
CREATE INDEX idx_queue_resources_type ON queue_resources(resource_type);
CREATE INDEX idx_queue_resources_price ON queue_resources(price_type);
CREATE INDEX idx_queue_resources_updated ON queue_resources(last_updated DESC);
CREATE INDEX idx_queue_resources_tags ON queue_resources USING GIN(tags);
...
SELECT 'Queue tables created with robust schema enforcement!' as message;